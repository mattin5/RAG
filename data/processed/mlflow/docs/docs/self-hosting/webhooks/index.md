---
doc_id: "mlflow/docs/docs/self-hosting/webhooks/index"
source_path: "mlflow/docs/docs/self-hosting/webhooks/index.mdx"
title: "Webhooks"
---
...
| budget_policy.exceeded | Triggered when a budget policy limit is exceeded | `BudgetPolicyExceededPayload` |
...
- `MlflowClient.create_webhook()`
- `MlflowClient.list_webhooks()`
- `MlflowClient.get_webhook()`
- `MlflowClient.update_webhook()`
- `MlflowClient.delete_webhook()`
- `MlflowClient.test_webhook()`
