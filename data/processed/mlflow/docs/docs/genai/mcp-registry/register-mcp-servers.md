---
doc_id: "mlflow/docs/docs/genai/mcp-registry/register-mcp-servers"
source_path: "mlflow/docs/docs/genai/mcp-registry/register-mcp-servers.mdx"
...
The most direct way to register an MCP server is by providing a [`server_json`](https://registry.modelcontextprotocol.io/docs#/schemas/ServerJSON) dictionary containing the server's configuration. Use `mlflow.genai.register_mcp_server`:
