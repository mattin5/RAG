---
doc_id: "mlflow/docs/docs/genai/mcp-registry/connect-to-servers"
source_path: "mlflow/docs/docs/genai/mcp-registry/connect-to-servers.mdx"
...
Use `mlflow.genai.create_mcp_access_endpoint`:
