---
doc_id: "mlflow/docs/docs/genai/tracing/app-instrumentation/manual-tracing"
source_path: "mlflow/docs/docs/genai/tracing/app-instrumentation/manual-tracing.mdx"
...
Use the `mlflow.get_current_active_span` API.
...
**Overriding auto-captured inputs and outputs inside a decorated function**
...
Use the `mlflow.start_span` context manager.
