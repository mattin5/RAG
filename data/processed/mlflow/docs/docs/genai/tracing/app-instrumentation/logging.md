---
doc_id: "mlflow/docs/docs/genai/tracing/app-instrumentation/logging"
source_path: "mlflow/docs/docs/genai/tracing/app-instrumentation/logging.mdx"
title: "Setting Log Levels on Spans"
---
...
- `mlflow.entities.SpanLogLevel` — the level enum.
- `mlflow.start_span` / `mlflow.start_span_no_context` / `mlflow.trace` — public APIs that accept the `log_level` kwarg.
