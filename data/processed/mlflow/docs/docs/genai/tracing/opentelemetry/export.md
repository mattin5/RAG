---
doc_id: "mlflow/docs/docs/genai/tracing/opentelemetry/export"
source_path: "mlflow/docs/docs/genai/tracing/opentelemetry/export.mdx"
title: "Export MLflow Traces/Metrics via OTLP"
---
...
This translates span types, model info, token usage, and messages into the standard `gen_ai.*` attributes before export. See [GenAI Semantic Conventions](/genai/tracing/opentelemetry/genai-semconv) for the full details and mapping reference.
