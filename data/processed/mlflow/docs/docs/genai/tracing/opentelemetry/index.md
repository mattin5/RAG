---
doc_id: "mlflow/docs/docs/genai/tracing/opentelemetry/index"
source_path: "mlflow/docs/docs/genai/tracing/opentelemetry/index.mdx"
...
To get started with vendor-neutral tracing quickly, you can use the OpenTelemetry-native MLflow Tracing SDK. The SDK provides a convenient one-line auto-tracing experience for [popular LLM and AI agent frameworks](/genai/tracing/integrations) and enhances general OpenTelemetry traces with rich AI-specific metadata such as prompts, token usage, model name, etc. See [Quickstart](/genai/tracing/quickstart) to get started with the MLflow Tracing SDK.
...
See [GenAI Semantic Conventions](/genai/tracing/opentelemetry/genai-semconv) for setup instructions and details.
