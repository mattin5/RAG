---
doc_id: "mlflow/docs/docs/genai/tracing/observe-with-traces/archive-traces"
source_path: "mlflow/docs/docs/genai/tracing/observe-with-traces/archive-traces.mdx"
title: "Archive Traces"
---
...
- If a trace is stuck in a malformed state, administrators can clear
  `mlflow.trace.archivalFailure` with `mlflow.client.MlflowClient.delete_trace_tag`
