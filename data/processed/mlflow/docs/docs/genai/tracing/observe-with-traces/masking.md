---
doc_id: "mlflow/docs/docs/genai/tracing/observe-with-traces/masking"
source_path: "mlflow/docs/docs/genai/tracing/observe-with-traces/masking.mdx"
title: "Redacting Sensitive Data from Traces"
---
...
1. Define a custom filtering function and call `mlflow.tracing.configure` to register it.
