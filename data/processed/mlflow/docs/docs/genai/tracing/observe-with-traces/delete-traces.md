---
doc_id: "mlflow/docs/docs/genai/tracing/observe-with-traces/delete-traces"
source_path: "mlflow/docs/docs/genai/tracing/observe-with-traces/delete-traces.mdx"
title: "Delete Traces"
---
...
**Not supported for Databricks Unity Catalog traces**
