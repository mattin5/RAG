---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/semantic_kernel"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/semantic_kernel.mdx"
...
[MLflow Tracing](/genai/tracing) provides automatic tracing capability for Semantic Kernel. By enabling auto tracing for Semantic Kernel via the `mlflow.semantic_kernel.autolog` function, MLflow will capture traces for LLM invocations and log them to the active MLflow Experiment.
