---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/dspy"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/dspy.mdx"
title: "Tracing DSPy🧩"
...
for DSPy by calling the `mlflow.dspy.autolog` function, and nested traces are automatically logged to the active MLflow Experiment upon invocation of DSPy modules.
