---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/openai-agent"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/openai-agent.mdx"
...
for OpenAI by calling the `mlflow.openai.autolog` function, MLflow will capture traces and log them to the active MLflow Experiment.
