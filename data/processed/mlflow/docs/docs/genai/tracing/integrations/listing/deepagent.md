---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/deepagent"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/deepagent.mdx"
...
Since Deep Agent is built on LangGraph, [MLflow Tracing](/genai/tracing) works out of the box via `mlflow.langchain.autolog`. This automatically captures the entire agent execution including planning, tool calls, and subagent interactions.
...
### 3. Enable Tracing and Create a Deep Agent
