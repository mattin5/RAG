---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/pydantic_ai"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/pydantic_ai.mdx"
...
[MLflow Tracing](/genai/tracing) provides automatic tracing capability for [​PydanticAI](https://ai.pydantic.dev/), an open source framework for building multi-agent applications. By enabling auto tracing for ​PydanticAI by calling the `mlflow.pydantic_ai.autolog` function, MLflow will capture nested traces for ​PydanticAI workflow execution and log them to the active MLflow Experiment.
