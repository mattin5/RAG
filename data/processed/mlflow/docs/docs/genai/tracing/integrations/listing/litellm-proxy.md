---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/litellm-proxy"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/litellm-proxy.mdx"
...
### 1. Install LiteLLM with MLflow Support
