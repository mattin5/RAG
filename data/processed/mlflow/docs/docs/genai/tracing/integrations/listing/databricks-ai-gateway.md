---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/databricks-ai-gateway"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/databricks-ai-gateway.mdx"
...
This guide covers tracing LLM calls through **Databricks AI Gateway**. If you're using Databricks Foundation Model APIs directly, see the [Databricks Integration](/genai/tracing/integrations/listing/databricks) guide instead.
