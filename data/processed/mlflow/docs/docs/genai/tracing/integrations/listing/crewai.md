---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/crewai"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/crewai.mdx"
...
for CrewAI by calling the `mlflow.crewai.autolog` function, , MLflow will capture nested traces for CrewAI workflow execution and logged them to the active MLflow Experiment.
