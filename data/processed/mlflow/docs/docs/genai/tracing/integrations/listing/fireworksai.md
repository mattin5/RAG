---
doc_id: "mlflow/docs/docs/genai/tracing/integrations/listing/fireworksai"
source_path: "mlflow/docs/docs/genai/tracing/integrations/listing/fireworksai.mdx"
...
[MLflow Tracing](/genai/tracing) provides automatic tracing capability for FireworksAI through the OpenAI SDK compatibility. FireworksAI is [OpenAI SDK compatible](https://fireworks.ai/docs/tools-sdks/openai-compatibility#openai-compatibility), you can use the `mlflow.openai.autolog` function to enable automatic tracing. MLflow will capture traces for LLM invocations and log them to the active MLflow Experiment.
