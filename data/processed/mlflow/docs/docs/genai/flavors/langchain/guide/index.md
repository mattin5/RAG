---
doc_id: "mlflow/docs/docs/genai/flavors/langchain/guide/index"
source_path: "mlflow/docs/docs/genai/flavors/langchain/guide/index.mdx"
title: "LangChain within MLflow (Experimental)"
...
You can also use the `mlflow.langchain.load_model` function to load a saved or logged MLflow
