---
doc_id: "mlflow/docs/docs/genai/flavors/dspy/index"
source_path: "mlflow/docs/docs/genai/flavors/dspy/index.mdx"
title: "MLflow DSPy Flavor"
...
[MLflow Tracing](/genai/tracing) tracing is a powerful feature that allows you to monitor and debug your DSPy programs. With MLflow, you can enable auto tracing just by calling the `mlflow.dspy.autolog` function in your code.
...
The saved module can be loaded back for inference using the `mlflow.pyfunc.load_model` function. This function
...
When using `mlflow.dspy.log_model` or `mlflow.dspy.save_model` in MLflow, the
