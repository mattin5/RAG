---
doc_id: "mlflow/docs/docs/genai/serving/responses-agent"
source_path: "mlflow/docs/docs/genai/serving/responses-agent.mdx"
title: "ResponsesAgent for Model Serving"
...
The `ResponsesAgent` extends MLflow's PyFunc model
...
- `mlflow.pyfunc.ResponsesAgent.create_text_delta` (only for streaming)
- `mlflow.pyfunc.ResponsesAgent.create_annotation_added` (only for streaming)
