---
doc_id: "mlflow/docs/docs/genai/serving/agent-server"
source_path: "mlflow/docs/docs/genai/serving/agent-server.mdx"
...
You can use `mlflow.genai.evaluate` to evaluate your agent. See the [Evaluating Agents](/genai/eval-monitor/) guide and [Scorer](/genai/eval-monitor/scorers) documentation for more information.
