---
doc_id: "mlflow/docs/docs/genai/governance/ai-gateway/endpoints/query-endpoints"
source_path: "mlflow/docs/docs/genai/governance/ai-gateway/endpoints/query-endpoints.mdx"
...
| **Passthrough** | OpenAI                             | `POST /gateway/openai/v1/chat/completions`
`POST /gateway/openai/v1/embeddings`
`POST /gateway/openai/v1/responses` | Full OpenAI API access including Chat Completions, Embeddings, and Responses endpoints.                                            |
