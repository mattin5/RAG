---
doc_id: "mlflow/docs/docs/genai/eval-monitor/automatic-evaluations/index"
source_path: "mlflow/docs/docs/genai/eval-monitor/automatic-evaluations/index.mdx"
...
- **Trace completion**: A trace becomes eligible for automatic evaluation 5 minutes after it starts by default. Configure the trace completion buffer to exceed the expected trace duration; traces that remain in progress longer than the buffer can be skipped
