---
doc_id: "mlflow/docs/docs/genai/eval-monitor/scorers/third-party/google-adk"
source_path: "mlflow/docs/docs/genai/eval-monitor/scorers/third-party/google-adk.mdx"
title: "Google ADK"
---
...
| ------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------------------------------- |
| ToolTrajectory | Does the agent call the correct tools in the expected order?         | [Link](https://google.github.io/adk-docs/evaluate/) |
| ResponseMatch   | How similar is the agent's response to a reference answer (ROUGE-1)? | [Link](https://google.github.io/adk-docs/evaluate/) |
...
| Scorer                                                                                        | What does it evaluate?                                             | ADK Docs                                            |
| --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------- |
| ResponseEvaluation | Does the agent's response match the expected response (LLM judge)? | [Link](https://google.github.io/adk-docs/evaluate/) |
| Safety                         | Is the agent's response safe and free of harmful content?          | [Link](https://google.github.io/adk-docs/evaluate/) |
| Hallucination           | Is the agent's response factually grounded (not hallucinated)?     | [Link](https://google.github.io/adk-docs/evaluate/) |
