---
doc_id: "mlflow/docs/docs/genai/eval-monitor/scorers/llm-judge/custom-judges/create-custom-judge"
source_path: "mlflow/docs/docs/genai/eval-monitor/scorers/llm-judge/custom-judges/create-custom-judge.mdx"
title: "Create a custom judge using 0"
---

# Create a custom judge using `make_judge()`

Custom judges are LLM-based judges that evaluate your LLM applications and AI agents against specific quality criteria. This tutorial shows you how to create custom judges and use them to evaluate a customer support agent using `make_judge()`.
