---
doc_id: "mlflow/docs/docs/genai/eval-monitor/scorers/llm-judge/predefined"
source_path: "mlflow/docs/docs/genai/eval-monitor/scorers/llm-judge/predefined.mdx"
...
To use the built-in LLM judges, select the judge class from the [available judges](#available-judges) and pass it to the `scorers` argument of the evaluate function.
...
| Completeness\*\*                                                             | Does the agent address all questions in a single user prompt? | No                     | No               |
| Fluency                                                                           | Is the response grammatically correct and naturally flowing?  | No                     | No               |
...
| Equivalence                                                                   | Is the app's response equivalent to the expected output?      | Yes                    | No               |
| Summarization                                                               | Is the summary faithful, comprehensive, concise, and clear?   | No                     | No               |
