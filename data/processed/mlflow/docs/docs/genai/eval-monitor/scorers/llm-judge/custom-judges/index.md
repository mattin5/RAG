---
doc_id: "mlflow/docs/docs/genai/eval-monitor/scorers/llm-judge/custom-judges/index"
source_path: "mlflow/docs/docs/genai/eval-monitor/scorers/llm-judge/custom-judges/index.mdx"
title: "Custom Judges"
...
The fastest way to create LLM judges is through the **Judge Builder UI** - no code required. Navigate to your experiment's **Judges** tab to create and test judges visually. See the [Create a Custom Judge](/genai/eval-monitor/scorers/llm-judge/custom-judges/create-custom-judge/#step-2-define-custom-judges) page for details.
