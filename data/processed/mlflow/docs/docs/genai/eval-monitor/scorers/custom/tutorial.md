---
doc_id: "mlflow/docs/docs/genai/eval-monitor/scorers/custom/tutorial"
source_path: "mlflow/docs/docs/genai/eval-monitor/scorers/custom/tutorial.mdx"
title: "Develop code-based scorers"
---

# Develop code-based scorers

In MLflow Evaluation, [custom code-based scorers](/genai/eval-monitor/scorers/custom) allow you to define flexible evaluation metrics for your AI agent or application.
