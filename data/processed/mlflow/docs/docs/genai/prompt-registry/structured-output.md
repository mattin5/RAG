---
doc_id: "mlflow/docs/docs/genai/prompt-registry/structured-output"
source_path: "mlflow/docs/docs/genai/prompt-registry/structured-output.mdx"
...
Use the `mlflow.genai.register_prompt` function with the `response_format` parameter to define structured output programmatically.
