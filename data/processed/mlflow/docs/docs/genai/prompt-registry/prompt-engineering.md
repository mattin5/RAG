---
doc_id: "mlflow/docs/docs/genai/prompt-registry/prompt-engineering"
source_path: "mlflow/docs/docs/genai/prompt-registry/prompt-engineering.mdx"
title: "Prompt Engineering UI (Experimental)"
---
...
MLflow AI Gateway using the mlflow server command as follows:
...
2. Then, to generate predictions, call the `predict()` method
...
3. Use the mlflow models serve command to start the MLflow Model Server. For example,
