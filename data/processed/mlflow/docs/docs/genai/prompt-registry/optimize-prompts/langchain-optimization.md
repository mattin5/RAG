---
doc_id: "mlflow/docs/docs/genai/prompt-registry/optimize-prompts/langchain-optimization"
source_path: "mlflow/docs/docs/genai/prompt-registry/optimize-prompts/langchain-optimization.mdx"
title: "Optimizing Prompts for LangChain"
---

# Optimizing Prompts for LangChain

This guide demonstrates how to leverage `mlflow.genai.optimize_prompts` alongside [LangChain](https://python.langchain.com/) to enhance your chain's prompts automatically. The `mlflow.genai.optimize_prompts` API is framework-agnostic, enabling you to perform end-to-end prompt optimization of your chains from any framework using state-of-the-art techniques. For more information about the API, please visit [Optimize Prompts](/genai/prompt-registry/optimize-prompts).
