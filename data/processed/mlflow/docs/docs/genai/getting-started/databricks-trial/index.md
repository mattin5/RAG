---
doc_id: "mlflow/docs/docs/genai/getting-started/databricks-trial/index"
source_path: "mlflow/docs/docs/genai/getting-started/databricks-trial/index.mdx"
title: "Try Managed MLflow"
...
To set up Databricks Workspace authentication, we can use the API `mlflow.login`, which will prompt you for required information:

- **Databricks Host**: Use "https://\.cloud.databricks.com/
