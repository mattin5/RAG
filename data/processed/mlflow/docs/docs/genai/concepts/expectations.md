---
doc_id: "mlflow/docs/docs/genai/concepts/expectations"
source_path: "mlflow/docs/docs/genai/concepts/expectations.mdx"
...
| `value`               | `Any`                      | The expected value, which can be
 ...
 Text responses (e.g., `"The capital of France is Paris"`)Structured data (e.g., `{"category": "complaint", "priority": "high"}`)Lists (e.g., `["doc_123", "doc_456"]` for expected retrieval results)Any JSON-serializable value representing the desired output |
