---
doc_id: "mlflow/docs/docs/genai/concepts/span"
source_path: "mlflow/docs/docs/genai/concepts/span.mdx"
title: "Spans"
...
To set a span type for manually created spans, you can pass the `span_type` parameter to the `mlflow.trace` decorator or `mlflow.start_span` context manager. When you are using [automatic tracing](/genai/tracing/app-instrumentation/automatic), the span type is automatically set by MLflow.
