---
doc_id: "mlflow/docs/docs/classic-ml/deployment/deploy-model-to-sagemaker/index"
source_path: "mlflow/docs/docs/classic-ml/deployment/deploy-model-to-sagemaker/index.mdx"
title: "Deploy MLflow Model to Amazon SageMaker"
---
...
The `mlflow deployments run-local` command deploys
...
The mlflow sagemaker build-and-push-container
...
Refer to the CLI reference for a complete list of options.
