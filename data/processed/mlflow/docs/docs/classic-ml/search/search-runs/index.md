---
doc_id: "mlflow/docs/docs/classic-ml/search/search-runs/index"
source_path: "mlflow/docs/docs/classic-ml/search/search-runs/index.mdx"
title: "Search Runs"
---
...
mlflow.entities.RunInfo, however note that not all fields in the RunInfo object are searchable.
...
`mlflow.client.MlflowClient.search_runs` or `mlflow.search_runs` take
...
the mlflow.entities.ViewType enum.
...
Finally, there are additional useful features in the `mlflow.client.MlflowClient.search_runs`
or `mlflow.search_runs` methods, so be sure to
