---
doc_id: "mlflow/docs/docs/classic-ml/traditional-ml/tutorials/creating-custom-pyfunc/part2-pyfunc-components/index"
source_path: "mlflow/docs/docs/classic-ml/traditional-ml/tutorials/creating-custom-pyfunc/part2-pyfunc-components/index.mdx"
title: "Understanding PyFunc in MLflow"
---
...
PyFunc versions of models are interacted with in the same way as any other MLflow model type, providing both `save_model()`
and `log_model()` interfaces in order to create (save) and access (load) the models respectively.
