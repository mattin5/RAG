---
doc_id: "mlflow/docs/docs/classic-ml/traditional-ml/tutorials/creating-custom-pyfunc/part1-named-flavors/index"
source_path: "mlflow/docs/docs/classic-ml/traditional-ml/tutorials/creating-custom-pyfunc/part1-named-flavors/index.mdx"
title: "Models, Flavors, and PyFuncs in MLflow"
---
...
`RandomForestModel`, all fall under the `Spark` flavor umbrella. This abstraction ensures that, irrespective of the model's foundational structure,
...
loaded `pyfunc` for inference deployment. Each flavor prescribes a `predict` method behavior, ensuring a consistent yet
somewhat rigid format.

To understand these constraints, consider the `sklearn` flavor as an example. The diagram below delineates its
...
However, there's a silver lining. MLflow offers the flexibility to craft a custom `pyfunc` by extending the foundational `PythonModel`
