---
doc_id: "mlflow/docs/docs/classic-ml/model/python_model"
source_path: "mlflow/docs/docs/classic-ml/model/python_model.mdx"
title: "MLflow PythonModel Guide"
---
...
Subclassing `mlflow.pyfunc.PythonModel` or defining a callable.
...
The `mlflow.pyfunc` module provides a generic PythonModel class
...
Methods of PythonModel:
    ...
    - **load_context**
        Implement the load_context method if the model requires additional context to be loaded. For more details, refer to load_context().
...
Use `mlflow.models.predict` API to validate the model dependencies and input data before deploy it.
...
By subclassing `mlflow.pyfunc.PythonModel`, you can get data validation based on the type hints for free.
