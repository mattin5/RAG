---
doc_id: "mlflow/docs/docs/classic-ml/model/models-from-code/index"
source_path: "mlflow/docs/docs/classic-ml/model/models-from-code/index.mdx"
...
1. Delete the MLflow run: Use the UI or `delete_run()` API
