---
doc_id: "mlflow/docs/docs/classic-ml/getting-started/quickstart"
source_path: "mlflow/docs/docs/classic-ml/getting-started/quickstart.mdx"
...
Looking for using MLflow for LLMs/Agent development? Checkout the [MLflow for GenAI](/genai) documentation instead. This guide is intended for data scientists who train traditional machine learning models, such as decision trees.
