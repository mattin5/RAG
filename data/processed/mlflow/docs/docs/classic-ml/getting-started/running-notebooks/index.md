---
doc_id: "mlflow/docs/docs/classic-ml/getting-started/running-notebooks/index"
source_path: "mlflow/docs/docs/classic-ml/getting-started/running-notebooks/index.mdx"
title: "Connect Your Development Environment to MLflow"
...
**[MLflow Assistant]**
Need help setting up MLflow? Try [MLflow Assistant](/genai/getting-started/try-assistant) - a powerful AI assistant that can help you set up MLflow for your project.
...
**[ACCESS DENIED?]**
  ...
  Refer to the [Network Security Guide](/self-hosting/security/network#cors-origins) for more details.
