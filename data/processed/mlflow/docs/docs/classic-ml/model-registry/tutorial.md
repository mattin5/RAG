---
doc_id: "mlflow/docs/docs/classic-ml/model-registry/tutorial"
source_path: "mlflow/docs/docs/classic-ml/model-registry/tutorial.mdx"
title: "Model Registry Tutorials"
---
...
- To register a model, you can leverage the `registered_model_name` parameter in the `mlflow.sklearn.log_model`
  or call `mlflow.register_model` after logging the model. Generally, we suggest the former because it's more
  concise.
...
not supported, you should leverage `mlflow.pyfunc.load_model`. Throughout this tutorial
