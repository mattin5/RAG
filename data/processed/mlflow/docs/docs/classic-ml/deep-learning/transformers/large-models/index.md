---
doc_id: "mlflow/docs/docs/classic-ml/deep-learning/transformers/large-models/index"
source_path: "mlflow/docs/docs/classic-ml/deep-learning/transformers/large-models/index.mdx"
title: "Working with Large Models in MLflow Transformers flavor"
---
...
- **Save method**: Normal pipeline-based logging
- **Description**: Log a model using a pipeline instance or a dictionary of pipeline components.
- **Memory Usage**: High
- **Disk Usage**: High
- **Example**:
...
- **Save method**: [Memory-Efficient Model Logging](#transformers-memory-efficient-logging)
- **Description**: Log a model by specifying a path to a local checkpoint, avoiding loading the model into memory.
- **Memory Usage**: ****Low****
- **Disk Usage**: High
- **Example**:
...
- **Save method**: [Storage-Efficient Model Logging](#transformers-save-pretrained-guide)
- **Description**: Log a model by saving a reference to the HuggingFace Hub repository instead of the model weights.
- **Memory Usage**: High
- **Disk Usage**: **Low**
- **Example**:
...
the `mlflow.transformers.log_model` API, instead of a pipeline instance.
...
To address this issue, MLflow 2.11.0 introduced a new argument `save_pretrained` in the `mlflow.transformers.save_model` and `mlflow.transformers.log_model` APIs.
...
the `mlflow.transformers.persist_pretrained_model` API to download the model weight from the HuggingFace Hub and save
...
model weight to the artifact store before registering the model. You can use the `mlflow.transformers.persist_pretrained_model`
